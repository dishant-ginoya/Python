data = {'1': 
            {'bill_no':'1','customer_name':'dishant', 'date':'25', 'products':
                                                                    {'product_1':
        ...
        '2': 
            {'bill_no':'2','customer_name':'darshan', 'date':'2', 'products':
                                                                    {'product_1':
...
class Bill():
    ...
    def add_bill(slef):
        ...
        i = 1
        data[bill_no] = {'bill_no':bill_no,'customer_name':name, 'date':date, 'products':{  }}
        while True:
            ...
            if ans == 'Y':
                ...
                data[bill_no]['products'][pro_cat] = ({'product_name':pro_name_1,'product_qty':pro_qty_1,'product_price':pro_price_1})
                i += 1
            elif ans == 'N':
                data[bill_no]['products'][pro_cat] = ({'product_name':pro_name,'product_qty':pro_qty,'product_price':pro_price})
                break
            else:
    ...
    def edit_bill(self, bill_no):
        if bill_no in data:
            ...
            for i in range(1,len(data[bill_no]['products'])+1):
                pro_cat = str('product_') + str(i)
                print()
                while True:
                    ...
                    if ans == 'Y':
                        while True:
                            ...
                            if ans == 'Y':
                                ...
                                data[bill_no]['products'][pro_cat]['product_name'] = pro_name
                                break
                            elif ans == 'N':
                                break
                            else:
                        ...
                        while True:
                            ...
                            if ans == 'Y':
                                ...
                                data[bill_no]['products'][pro_cat]['product_qty'] = pro_qty
                                break
                            elif ans == 'N':
                                break
                            else:
                        ...
                        while True:
                            ...
                            if ans == 'Y':
                                ...
                                data[bill_no]['products'][pro_cat]['product_price'] = pro_price
                                break
                            elif ans == 'N':
                                break
                            else:
    ...
    def view_customer(self, bill_no):
        if bill_no in data:
            print()
